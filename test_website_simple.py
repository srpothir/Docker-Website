#!/usr/bin/env python3
"""
Simple test file for personal website functionality
...
def test_html_files_exist():
    ...
    print("[PASS] All required HTML files exist")
...
def test_images_directory():
    ...
    print(f"[PASS] Images directory exists with {len(image_files)} files")
...
def test_responsive_design():
    ...
    print("[PASS] Responsive design elements found")
...
def test_contact_form():
    ...
    assert 'button' in content, "No button element found"
    
    print("[PASS] Contact form structure is valid")
